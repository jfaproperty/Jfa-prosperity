      ...
      <div className="space-y-2 pt-1">
        <label className="flex items-start gap-2.5 cursor-pointer">
          ...
          <span className="text-xs text-gray-500 leading-relaxed">
            I agree to receive non-marketing SMS messages from JFA Property LLC regarding cash offer updates. Msg & data rates may apply. Reply STOP to unsubscribe. Reply HELP for help. Message frequency varies. Terms:{' '}
        ...
        <label className="flex items-start gap-2.5 cursor-pointer">
          ...
          />
          <span className="text-xs text-gray-500 leading-relaxed">
            I agree to receive marketing SMS messages from JFA Property LLC regarding promotional offers. Msg & data rates may apply. Reply STOP to unsubscribe. Reply HELP for help. Message frequency varies. Terms:{' '}
            <a href="/privacy#terms" className="text-brand-600 underline">Terms of Service</a>{' '}|{' '}
            <a href="/privacy" className="text-brand-600 underline">Privacy Policy</a>
          </span>
        </label>
