    ...
    <div>
      ...
      <div className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 space-y-16">
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-shrink-0 w-20 h-20 rounded-2xl bg-brand-600 text-white font-bold text-3xl flex items-center justify-center">01</div>
            <div>
              <h2 className="text-2xl font-bold text-brand-800 mb-3">Tell Us About Your House</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-shrink-0 w-20 h-20 rounded-2xl bg-brand-600 text-white font-bold text-3xl flex items-center justify-center">02</div>
            <div>
              <h2 className="text-2xl font-bold text-brand-800 mb-3">We Evaluate and Make an Offer</h2>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="flex-shrink-0 w-20 h-20 rounded-2xl bg-brand-600 text-white font-bold text-3xl flex items-center justify-center">03</div>
            <div>
              <h2 className="text-2xl font-bold text-brand-800 mb-3">Close and Receive Your Cash</h2>
      ...
      <div className="py-16 bg-brand-50">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-brand-900 mb-4">Ready to Get Started?</h2>
